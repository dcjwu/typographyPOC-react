...
const Login = () => {
    ...
    const {setAuthError, currentUser, showSuccessMessage} = useSelector(({auth}) => auth)
        ...
        <div className='container-content'>
            ...
            <form className='mt-5 form-custom' onSubmit={handleFormSubmit}>
                <div className="form-group mb-5">
                    <Input type='email' placeholder='Email address...' value={email} onUpdateValue={onInputEmail}/>
                </div>
                <div className="form-group mb-5">
                    <Input type='password' placeholder='Password...' value={password} onUpdateValue={onInputPassword}/>
                </div>
